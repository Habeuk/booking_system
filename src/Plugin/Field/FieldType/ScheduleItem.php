...
class ScheduleItem extends FieldItemBase {
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition) {
    $properties['start_hour'] = DataDefinition::create('string')->setLabel(t('start hour'));

    $properties['end_hour'] = DataDefinition::create('string')->setLabel(t('end hour'));

    $properties['start_date'] = DataDefinition::create('integer')->setLabel(t('start date'));

    $properties['end_date'] = DataDefinition::create('integer')->setLabel(t('end date'));

    $properties['discount'] = DataDefinition::create('integer')->setLabel(t('discount'));

    $properties['status'] = DataDefinition::create('boolean')->setLabel(t('status'));
