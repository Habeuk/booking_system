...
/**
 * Provides a form for reverting a Booking config revision.
 *
 * @ingroup booking_system
 */
class BookingConfigRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'booking_config_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Booking config: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    $this->messenger()->addMessage(t('Booking config %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\booking_system\Entity\BookingConfigInterface $revision
