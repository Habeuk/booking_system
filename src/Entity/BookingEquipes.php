 ...
 *     "add-form" = "/admin/structure/booking_equipes/add",
 ...
 *   },
 *   field_ui_base_route = "booking_equipes.settings"
 * )
 */
class BookingEquipes extends EditorialContentEntityBase implements BookingEquipesInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Booking equipes entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Booking equipes entity.'))
      ->setRevisionable(TRUE)
      ->setSettings([
        'max_length' => 50,
        'text_processing' => 0,
    ...
    $fields['status']->setDescription(t('A boolean indicating whether the Booking equipes is published.'))
      ->setDisplayOptions('form', [
