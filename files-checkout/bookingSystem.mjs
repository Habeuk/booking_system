...
function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    withDirectives(createElementVNode("div", _hoisted_1$n, [
            ...
            createElementVNode("div", _hoisted_8$5, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(time.times, (heure, i) => {
                return openBlock(), createElementBlock("span", {
                  ...
                  createElementVNode("span", _hoisted_10$3, toDisplayString(heure.hour), 1)
                ], 10, _hoisted_9$4);
              }), 128))
            ])
          ]);
      ...
      createElementVNode("div", _hoisted_11$3, "Creneaux restant : " + toDisplayString($props.hoursRemaining), 1),
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.steps.length, (index3) => {
          return openBlock(), createElementBlock("div", {
            ...
            createElementVNode("div", _hoisted_11$2, [
              $props.steps[index3 - 1].value instanceof String || typeof $props.steps[index3 - 1].value == "string" ? (openBlock(), createElementBlock("span", _hoisted_12$2, toDisplayString($props.steps[index3 - 1].value), 1)) : (openBlock(), createElementBlock("div", _hoisted_13, [
...
const _sfc_main$j = {
  ...
  setup(props, { emit }) {
    ...
    onMounted(() => {
      ...
      setTimeout(() => {
        if (submitBtn.value) {
          console.log("OK, find reference element");
          submitBtn.value.click();
        } else {
          console.log("ERROR, find reference element");
          document.querySelector(".commerce-checkout-flow-booking-system-checkf").submit();
        }
      }, 250);
    });
    return {
...
const _hoisted_10$1 = /* @__PURE__ */ createElementVNode("div", { class: "report-title green" }, "Etape suivante", -1);
const _hoisted_11$1 = [
  _hoisted_10$1
];
const _hoisted_12$1 = /* @__PURE__ */ createElementVNode("div", null, [
...
function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    $props.isLoading ? (openBlock(), createBlock(_component_ProgressSpinner, {
      ...
      createElementVNode("button", _hoisted_9$2, _hoisted_11$1, 512),
      _hoisted_12$1
    ], 2))
  ], 2);
}
...
const App_vue_vue_type_style_index_0_scoped_ec6273ca_lang = "";
const App = /* @__PURE__ */ _export_sfc$1(_sfc_main$i, [["__scopeId", "data-v-ec6273ca"]]);
var FilterMatchMode = {
